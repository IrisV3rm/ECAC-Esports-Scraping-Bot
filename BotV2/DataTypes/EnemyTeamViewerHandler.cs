...
namespace BotV2.DataTypes
{
    public class EnemyTeamViewerHandler
    {
        ...
        public EnemyTeamViewerHandler(string teamIcon, string school, string teamName, string currentGame, string winCount, string lossCount, string winPercent, List<User> users)
        {
            TeamIcon = teamIcon;
            School = school;
            TeamName = teamName;
