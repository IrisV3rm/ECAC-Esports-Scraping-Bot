...
namespace ECAC_eSports_Bot.Classes.SavingLoading
{
    public class IniFileParser
    {
        ...
        public void Load(string filePath)
        {
            ...
            {
                SetValue("ECAC", "Username", "");
                SetValue("ECAC", "Password", "");
                SetValue("ECAC", "Game", "Valorant");
                SetValue("ECAC", "ApiType", "TrackerGg");
        ...
        {
            if (section != null && _sections.TryGetValue(section, out Dictionary<string, string>? sectionData) && sectionData.TryGetValue(key, out string? value))
            {
                return value;
            }
            return defaultValue;
